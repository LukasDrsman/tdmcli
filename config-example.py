# when done configuring, rename this file to 'config.py'

# import 'colors.py'
from colors import *

# Terminal escapes as defined in 'colors.py'
# To overwrite color from 'colors.py', change the
